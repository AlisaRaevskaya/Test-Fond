        ...
        <div class="modal-content">
            ...
            <form action="/call" method="POST" name="callForm">
                ...
                <div class="modal-footer">
                    <div class="block pull-left f-size10">Нажимая «Отправить» вы соглашаетесь с
                        <a href="/storage/app/public/pdf/politika_confidence.pdf" target="_blank"
                            class="consent underline">
                            Политикой обработки персональных данных.</a>
                    </div>
                    <br>
                    <div class="success_call text-center success-btn"></div>
