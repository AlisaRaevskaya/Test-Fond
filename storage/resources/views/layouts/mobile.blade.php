<button type="button" class="close hidden" aria-hidden="true" data-toggle="offcanvas"
...
<script>
    $(".slide-along .uc - offcanvas - container").addClass('transparent');
    $(window).on("load", function() {
        $(".mobile_box").removeClass('hidden');
        $("#uc-mobile-menu-close-btn").removeClass('hidden');
 $(".slide-along .uc - offcanvas - container").removeClass('transparent');
    });
